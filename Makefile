...
# current Stage 4R4A affine-demand Bertrand gate.
all: verify
...
verify:
	...
	@echo "STAGE 4R4A CURRENT GATE: affine-demand Bertrand continuation and endogenous-repositioning witness verified"
